...
// 结果返回的是二进制数据，默认被转成了16进制
// 可以通过toString()方法转成人类可以识别的字符
fs.readFile('./data/a.txt',function(err,data){
   if(err){
       // 因为如果成功的话此处的error为null,也就是false，如果失败的话返回一个失败对象，可以看作true.
       // 如果失败的话返回一个{...}对象，也就是true，所以这里对err进行判断处理，来判断是否读取成功比较适合。
        console.log('文件读取失败');
   }
    else{
...
server.on('request',function(request,response){
    console.log('收到客户的请求路径：'+request.url);
    // response对象有一个方法：write可以用来给客户端发送响应数据
    // write 可以使用多次，但是最后一定要使用end来结束响应，否则客户端会一直等待响应结束
    response.write('hello');
    response.write('nodejs');
    // 告诉客户端，我的话说完了，你可以呈递给用户了
    response.end();
    //可以直接采用 response.end('hello nodejs')来传递参数，同时结束响应。这样更加的常用
    // 不同的路径响应不同的值，依据request.url作为判断条件
    var url =request.url
    if(url === '/'){
...
// 思考：希望不同的请求路径响应不同的结果。
//例如：/index、/login、/register、/haha。
// 可以考虑依据request.url这个条件来用if进行判断。
3
```



![image-20200513210340393](nodeJS学习笔记.assets/image-20200513210340393.png)



![image-20200513211114896](nodeJS学习笔记.assets/image-20200513211114896.png)



![image-20200513213903696](nodeJS学习笔记.assets/image-20200513213903696.png)



![image-20200513215044948](nodeJS学习笔记.assets/image-20200513215044948.png)
...
![image-20200513224841375](nodeJS学习笔记.assets/image-20200513224841375.png)





![image-20200513225430391](nodeJS学习笔记.assets/image-20200513225430391.png)



![image-20200513225611318](nodeJS学习笔记.assets/image-20200513225611318.png)
...
![image-20200513232121506](nodeJS学习笔记.assets/image-20200513232121506.png)





![image-20200513231531853](nodeJS学习笔记.assets/image-20200513231531853.png)





![image-20200513232240547](nodeJS学习笔记.assets/image-20200513232240547.png)
...
![image-20200513232737451](nodeJS学习笔记.assets/image-20200513232737451.png)



![image-20200513233612213](nodeJS学习笔记.assets/image-20200513233612213.png)



![image-20200513233959031](nodeJS学习笔记.assets/image-20200513233959031.png)



![image-20200513235106987](nodeJS学习笔记.assets/image-20200513235106987.png)



![image-20200513235332739](nodeJS学习笔记.assets/image-20200513235332739.png)



![image-20200513235738947](nodeJS学习笔记.assets/image-20200513235738947.png)
...
server.on('request',function(request,response){
    ...
    if(code === '/'){
        ...
        return ;
    } else if(code === '/htmlFile'){// html文件字符串解析
        // 读取html文件
...
- 核心模块
  ...
  以后只要我们说这个模块是一个核心模块，你就要马上想到如果想要使用它，就必须：
...
![image-20200513222743971](nodeJS学习笔记.assets/image-20200513222743971.png)





![image-20200513221511294](nodeJS学习笔记.assets/image-20200513221511294.png)



![image-20200513223009054](nodeJS学习笔记.assets/image-20200513223009054.png)



![image-20200513223752821](nodeJS学习笔记.assets/image-20200513223752821.png)
