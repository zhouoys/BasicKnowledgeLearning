...
```javascript
var div1 = documents.getElementById("box1");      //方式一：通过id获取单个标签

var arr1s = document.getElementsByTagName("div");     //方式二：通过s 标签名 获得 标签数组，所以有s

var arr2s = document.getElementsByClassName("hehe");  //方式三：通过 类名 获得 标签数组，所以有s
```
